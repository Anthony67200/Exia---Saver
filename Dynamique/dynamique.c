...
int InitTime()
{
	...
	for (z=0;z<8;z++)
	{
		...
		{
			case 0:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/0.pbm", "r");
				break;
			case 1:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/1.pbm", "r");
				break;
			case 2:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/2.pbm", "r");
				break;
			case 3:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/3.pbm", "r");
				break;
			case 4:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/4.pbm", "r");
				break;
			case 5:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/5.pbm", "r");
				break;
			case 6:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/6.pbm", "r");
				break;
			case 7:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/7.pbm", "r");
				break;
			case 8:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/8.pbm", "r");
				break;
			case 9:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/9.pbm", "r");
				break;
			case 20:
				fichier1 = fopen("EXIASAVER2_PBM/3x5/point.pbm", "r");
				break;
		}
